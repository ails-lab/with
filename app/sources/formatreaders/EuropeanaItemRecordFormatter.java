...
public class EuropeanaItemRecordFormatter extends CulturalRecordFormatter {
	...
	public CulturalObject fillObjectFrom(JsonContextRecord rec) {
		...
		List<String> langs = rec.getStringArrayValue("proxies[0].dcLanguage", "europeanaAggregation.edmLanguage",
				"language");
		...
		model.setCoordinates(StringUtils.getPoint(rec.getStringValue("places[.*].latitude"),
				rec.getStringValue("places[.*].longitude")));
		...
		model.setDctermsspatial(rec.getMultiLiteralOrResourceValue("proxies[0].dctermsSpatial", "places[.*].about",
				"places[.*].about", "places[.*].prefLabel"));
